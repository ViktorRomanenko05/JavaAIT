...
public class TestNetwork {
    ...
    public static void main(String[] args) {
        ...
        User user1 = new User("Sofia Rossi", 5673);
        User user2 = new User("Liam O'Connor", 8362);
        User user3 = new User("Anika Patel", 3038);
        User user4 = new User("Juan Martínez", 4176);
        User user5 = new User("Yara Da Silva", 3895);
        User user6 = new User("Noah Müller", 6983);
        User user7 = new User("Mei Chen", 7025);
        User user8 = new User("Nathan Dubois", 8221);
        User user9 = new User("Ayaan Sharma", 9931);
        User user10 = new User("Emily Johnson", 1009);
        User user11 = new User("Emily Johnson", 1009);
        ...
        Community community1 = new Community("Java Coders");
        Community community2 = new Community("Our pets");
        Community community3 = new Community("Maxi Cooking");
        ...
        Message message1 = new Message(user1, "Hello everyone", LocalDateTime.now());
        Message message2 = new Message(user2, "I'm happy to be here", LocalDateTime.now());
        Message message3 = new Message(user3, "My name is Anika. I'm hungry", LocalDateTime.now());
        Message message4 = new Message(user1, "I love cats", LocalDateTime.now());
        Message message5 = new Message(user1, "I'm found new friends here", LocalDateTime.now());
        Message message6 = new Message(user8, "My dog is back", LocalDateTime.now());
        Message message7 = new Message(user8, "Hallo Hallo my darling :)", LocalDateTime.now());
